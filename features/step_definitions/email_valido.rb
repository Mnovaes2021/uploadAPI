Dado('que realizo um cadastro da empresa') do
  ...
  Dado('que busco o cadastro da empresa nao cadastrada') do
    endpoint = DATA['endpoint']['details_users']
  ...
  Entao('valido que essa empresa nao foi cadastrado com sucesso') do
